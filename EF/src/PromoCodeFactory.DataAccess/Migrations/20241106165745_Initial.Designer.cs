...
namespace PromoCodeFactory.DataAccess.Migrations
{
    ...
    [Migration("20241106165745_Initial")]
            ...
            modelBuilder.Entity("PromoCodeFactory.Core.Domain.Administration.Employee", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 11, 6, 19, 57, 45, 637, DateTimeKind.Local).AddTicks(870))
            ...
            modelBuilder.Entity("PromoCodeFactory.Core.Domain.Administration.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 11, 6, 19, 57, 45, 639, DateTimeKind.Local).AddTicks(7110))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("PromoCodeFactory.Core.Domain.PromoCodeManagement.Customer", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 11, 6, 19, 57, 45, 620, DateTimeKind.Local).AddTicks(3120))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("PromoCodeFactory.Core.Domain.PromoCodeManagement.Preference", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 11, 6, 19, 57, 45, 638, DateTimeKind.Local).AddTicks(6820))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("PromoCodeFactory.Core.Domain.PromoCodeManagement.PromoCode", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 11, 6, 19, 57, 45, 639, DateTimeKind.Local).AddTicks(2110))
                        .HasColumnName("created_at");
